...
{
    string idEdificio; //representa a un edificio
    int alturaEdificio; //representa la altura de un edificio
...
vector<string> resolver(const vector<tZona>&datos) {
    ...
    while (interior >= 0) //sigue habiendo edicicios
    {
...
#ifndef DOMJUDGE
    std::ifstream in("casos_apartamentos.txt");
